...
/** @type {string} */
const CACHE_VERSION = '1771385792|15504844187';
/** @type {string} */
const CACHE_PREFIX = 'ProjectPlaygroun-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '2DPlatformer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["2DPlatformer.html","2DPlatformer.js","2DPlatformer.offline.html","2DPlatformer.icon.png","2DPlatformer.apple-touch-icon.png","2DPlatformer.audio.worklet.js","2DPlatformer.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["2DPlatformer.wasm","2DPlatformer.pck"];
